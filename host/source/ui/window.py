...
class Ui_Watcher(object):
    def setupUi(self, Watcher):
        ...
        self.RSSI.setEnabled(True)
        self.RSSI.setStyleSheet("font: 87 10pt \"Droid Sans [MONO]\";")
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(0, 40, 479, 51))
        ...
        self.workButton.setStyleSheet("font: 75 14pt \"Droid Sans [MONO]\";")
        ...
        self.settingsButton.setStyleSheet("font: 75 14pt \"Droid Sans [MONO]\";")
        ...
        self.telemetryButton.setStyleSheet("font: 75 14pt \"Droid Sans [MONO]\";")
    ...
    def retranslateUi(self, Watcher):
        ...
        self.settingsButton.setText(_translate("Watcher", "НАСТРОЙКИ 1"))
        self.telemetryButton.setText(_translate("Watcher", "НАСТРОЙКИ 2"))
