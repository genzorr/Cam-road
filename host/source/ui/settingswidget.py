...
class Ui_SForm(object):
    def setupUi(self, SForm):
        ...
        self.label_3.setGeometry(QtCore.QRect(60, 15, 181, 20))
        self.label_3.setObjectName("label_3")
        self.EndPointsReverse = QtWidgets.QToolButton(self.widget_3)
        self.EndPointsReverse.setGeometry(QtCore.QRect(240, 10, 30, 30))
        ...
        self.label_6.setGeometry(QtCore.QRect(280, 15, 181, 20))
    ...
    def retranslateUi(self, SForm):
        ...
        self.label_6.setText(_translate("SForm", "РЕВЕРС В КОН. ТОЧКАХ"))
