...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Velocity.setProperty("value", 0)
        self.Velocity.setFormat("")
        ...
        self.Base1 = QtWidgets.QToolButton(self.verticalLayoutWidget_4)
        self.Base1.setText("")
        self.Base1.setCheckable(True)
        self.Base1.setObjectName("Base1")
        self.horizontalLayout.addWidget(self.Base1)
        ...
        self.Coordinate.setMinimum(0)
        self.Coordinate.setProperty("value", 0)
        self.Coordinate.setFormat("")
        self.Coordinate.setObjectName("Coordinate")
        self.horizontalLayout.addWidget(self.Coordinate)
        self.Base2 = QtWidgets.QToolButton(self.verticalLayoutWidget_4)
        self.Base2.setText("")
        self.Base2.setCheckable(True)
        self.Base2.setObjectName("Base2")
        self.horizontalLayout.addWidget(self.Base2)
