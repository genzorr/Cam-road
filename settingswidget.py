...
class Ui_SForm(object):
    def setupUi(self, SForm):
        ...
        self.EndPointsEnable = QtWidgets.QToolButton(self.widget)
        self.EndPointsEnable.setGeometry(QtCore.QRect(10, 10, 30, 30))
        self.EndPointsEnable.setText("")
        self.EndPointsEnable.setCheckable(True)
        self.EndPointsEnable.setObjectName("EndPointsEnable")
        ...
        self.EndPointsBehavior = QtWidgets.QToolButton(self.widget_3)
        self.EndPointsBehavior.setGeometry(QtCore.QRect(10, 10, 30, 30))
        self.EndPointsBehavior.setText("")
        self.EndPointsBehavior.setCheckable(True)
        self.EndPointsBehavior.setObjectName("EndPointsBehavior")
    ...
    def retranslateUi(self, SForm):
        ...
        self.label_3.setText(_translate("SForm", "ОСТАНОВ/РЕВЕРС В КОНЕЧНЫХ ТОЧКАХ"))
